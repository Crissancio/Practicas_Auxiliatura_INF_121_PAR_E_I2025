...
f1 = Farmacia("VidaSana", 1, "Av. Sur 456")
f1.agregar(Medicamento("Aspirina", 201, "Dolor", 3.5))
f1.agregar(Medicamento("Antigripal", 202, "Resfrío", 6.0))
f1.agregar(Medicamento("JarabeTos", 203, "Tos", 7.0))
archivo.agregar(f1)

f2 = Farmacia("SaludPlus", 2, "Av. Norte 123")
f2.agregar(Medicamento("Golpex", 301, "Tos", 8.5))
f2.agregar(Medicamento("Paracetamol", 302, "Dolor", 4.0))
archivo.agregar(f2)
