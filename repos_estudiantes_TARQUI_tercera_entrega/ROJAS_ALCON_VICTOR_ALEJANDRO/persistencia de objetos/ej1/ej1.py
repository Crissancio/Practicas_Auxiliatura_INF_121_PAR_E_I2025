...
if __name__ == "__main__":
    ...
    archivo.guardar_empleado(Empleado("Ana", 30, 1500))
    archivo.guardar_empleado(Empleado("Luis", 28, 2000))
    archivo.guardar_empleado(Empleado("Marcelo", 35, 3800))

    buscado = archivo.busca_empleado("Luis")
    if buscado:
