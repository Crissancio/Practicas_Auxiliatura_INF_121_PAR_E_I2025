...
if __name__ == "__main__":
    ...
    archivo.guardar_cliente(Cliente(1, "Ana", 25, "La Paz", 76543210))
    archivo.guardar_cliente(Cliente(2, "Luis", 28, "Cochabamba", 71234567))
    archivo.guardar_cliente(Cliente(3, "Eduardo", 40, "La Paz", 79876543))

    buscado = archivo.buscar_cliente("Ana")
    if buscado:
