public class Desarrollador extends Empleado {
    ...
    public Desarrollador(String nombre, String apellido, double salario_base, int años_antiguedad,
            String lenguaje_programacion, int horas_extras) {
    ...
    public double calcular_salario(){
        double monto_adicional = this.horas_extras * 20;
        return super.calcular_salario() + monto_adicional;
    }

    public String toString(){
        return ("-----------Desarrollador----------\n"+
                "Lenguaje de Programacion:"+ this.lenguaje_programacion +"\n" + 
                "Horas extras:"+ this.horas_extras  
        );
    }
